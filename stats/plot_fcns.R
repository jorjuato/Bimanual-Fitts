...
plot_interactions <- function(mdata,vname,vpath){
    ...
    ip2<-interaction2wt(form,responselab=vname,subset=mdata$S==4,main.in=paste(vname," Group vs IDL-IDR, S4"),mdata)
    ip3<-interaction2wt(form,responselab=vname,subset=mdata$S==7,main.in=paste(vname," Group vs IDL-IDR, S7"),mdata)
    ...
    ip2<-interaction2wt(form,responselab=vname,subset=mdata$S==4,main.in=paste(vname,"  PP vs IDL-IDR, S4"),mdata)
    ip3<-interaction2wt(form,responselab=vname,subset=mdata$S==7,main.in=paste(vname,"  PP vs IDL-IDR, S7"),mdata)
...
plot_boxplots <- function(mdata,vname,vpath){
    ...
    bw2<-bwplot(form,mdata,main = "Group vs IDL-IDR Session 4",subset=mdata$S==4,ylim=ylim_var)
    bw3<-bwplot(form,mdata,main = "Group vs IDL-IDR Session 7",subset=mdata$S==7,ylim=ylim_var)
    ...
    bw2<-bwplot(form,mdata,main = "Participant vs IDR-IDL  Session 4",subset=mdata$S==4,ylim=ylim_var)
    bw3<-bwplot(form,mdata,main = "Participant vs IDR-IDL  Session 7",subset=mdata$S==7,ylim=ylim_var)
...
plot_densityplot <- function(mdata,vname,vpath){
    ...
    dens_g1_s4<-histogram(form,mdata,main = "Coupled Session 4",type="density",subset=(mdata$S==4 & mdata$grp=="U"),panel=hist_density)
    dens_g1_s7<-histogram(form,mdata,main = "Coupled Session 7",type="density",subset=(mdata$S==7 & mdata$grp=="U"),panel=hist_density)
    dens_g2_s1<-histogram(form,mdata,main = "Uncoupled Session 1",type="density",subset=(mdata$S==1 & mdata$grp=="C"),panel=hist_density)
    dens_g2_s4<-histogram(form,mdata,main = "Uncoupled Session 4",type="density",subset=(mdata$S==4 & mdata$grp=="C"),panel=hist_density)
    dens_g2_s7<-histogram(form,mdata,main = "Uncoupled Session 7",type="density",subset=(mdata$S==7 & mdata$grp=="C"),panel=hist_density)
