...
% the appropriate subscript reference function.
    ...
    while ~isempty(subscript)
        ...
        if isequal(class(s), 'Block') % See if the referenced object is a myclass object.        
            ...
            switch thisSubscript.type            
                ...
                case '{}'
                    s = s.data_set{thisSubscript.subs{:}};
                    %error('Improper subscript reference for Block object.')
                case '.'
