    ...
    if obj.unimanual==0
        for idx1=1:obj.size(1)
            for idx2=1:obj.size(2)
                ...
                tr.vfL.pc = (ds{idx1,idx2,1}.vfL.pc+ds{idx1,idx2,3}.vfL.pc+ds{idx1,idx2,3}.vfL.pc)/3;
                tr.vfR.pc = (ds{idx1,idx2,1}.vfR.pc+ds{idx1,idx2,3}.vfR.pc+ds{idx1,idx2,3}.vfR.pc)/3;
        ...
        for idx1=1:obj.size(1)
            ...
            tr.vfL.pc = (ds{idx1,1}.vf.pc+ds{idx1,3}.vf.pc+ds{idx1,3}.vf.pc)/3;
            % Add concatenated trial to DS cell array
            tr.set_concatenated();
