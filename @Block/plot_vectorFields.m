    ...
    if mode==1 %All graphs in same figure
        ...
        for i=1:IDR
            for j=1:IDL
                ...
                ylabel(sprintf('IDR=%1.2f',DS{j,i,1}.info.RID),'fontsize',10,'fontweight','b'); 
                xlabel('Left Hand','fontsize',10,'fontweight','b');
                %Shall we plot the title?
                if i==1 & j==1 & titledone == 0
                    title(sprintf('\t IDL=%1.2f',DS{1,1,1}.info.LID),'fontsize',12,'fontweight','b');                     
                    titledone = 1;
                elseif i==1 & j==2 & titledone == 1
                    title(sprintf('\t IDL=%1.2f',DS{2,1,1}.info.LID),'fontsize',12,'fontweight','b');                     
                    titledone = 2;
                end 
