function [dataBi,dataUn,varnamesBi,varnamesUn, vartypesBi, vartypesUn] = get_data(xp,grp,avg,rel)
    ...
    if rel==1 % always average data for relative measures
        dataUn=zeros(length(varnamesBi),hands,g,ss,idr,r)*NaN;
        dataBi=zeros(length(varnamesUn),hands,g,ss,idl,idr,r)*NaN;
