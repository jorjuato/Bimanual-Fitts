                    ...
                    for c=1:3 % replication number
                        ...
                        for v=1:length(varnamesBi)
                            ...
                            elseif strcmp(vartypesBi{v},'osc')
                                if strcmp(varnamesBi{v},'IDown')
                                    v1=find([a{:}]=='MTown')
                                    dataBi(v,1,g,s,a,b,idx)=nanmedian(pp(s).bimanual{a,b,c}.oscL.MTown);
                                    dataBi(v,1,g,s,a,b,idx)=nanmedian(pp(s).bimanual{a,b,c}.oscL.(varnamesBi{v}));
                                    dataBi(v,1,g,s,a,b,idx)=nanmedian(pp(s).bimanual{a,b,c}.oscL.(varnamesBi{v}));
                                    dataBi(v,1,g,s,a,b,idx)=nanmedian(pp(s).bimanual{a,b,c}.oscL.(varnamesBi{v}));
                                elseif strcmp(varnamesBi{v},'MTown') || strcmp(varnamesBi{v},'IDother')
                                    continue
                                else                                    
                                    dataBi(v,1,g,s,a,b,idx)=nanmedian(pp(s).bimanual{a,b,c}.oscL.(varnamesBi{v}));
