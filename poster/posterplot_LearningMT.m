...
function  posterplot_LearningMT(MTR,MTL,MTRu,MTLu)
        ...
        for r=1:idr
            for l=1:idl     
                ...
                if g==3
                    ...
                    for s=1:ss
                        bar_grps(1,ord,cnt,s,1)=mean(MTLu(2,s,l,:));
                        bar_grps(1,ord,cnt,s,2)=std(MTLu(2,s,l,:));
                        bar_grps(2,ord,cnt,s,1)=mean(MTRu(2,s,r,:));
                        bar_grps(2,ord,cnt,s,2)=std(MTRu(2,s,r,:));
                    end
                else                    
                    for s=1:ss
                        bar_grps(1,ord,cnt,s,1)=mean(MTL(g,s,l,r,:));
                        bar_grps(1,ord,cnt,s,2)=std(MTL(g,s,l,r,:));       
                        bar_grps(2,ord,cnt,s,1)=mean(MTR(g,s,l,r,:));
                        bar_grps(2,ord,cnt,s,2)=std(MTR(g,s,l,r,:));
                    end            
                end
            end
        end
