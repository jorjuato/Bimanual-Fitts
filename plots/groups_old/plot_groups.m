function plot_groups(dataBi,dataUn,varnamesBi,varnamesUn, vartypesBi, vartypesUn)
    ...
    %Rearrange data matrices if needed
    [~, ~, grp, ~, ~, ~,~]=size(dataBi);
    if grp==10
        dataBi=group_participant_data(dataBi);
        dataUn=group_participant_data(dataUn);
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  bar_grps = plot_groups_MT(bi,un,biNames,unNames)
