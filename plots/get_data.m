function [dataBi,dataUn,varnamesBi,varnamesUn, vartypesBi, vartypesUn] = get_data(xp,grp,avg)
                    ...
                    for c=1:3 % replication number
                        ...
                        for v=1:length(varnamesBi)
                            if strcmp(vartypesBi{v},'ts')
                                if strcmp(varnamesBi{v},'Harmonicity') || strcmp(varnamesBi{v},'Circularity')
